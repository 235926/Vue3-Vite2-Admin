...
- 🐞 修复 [标记为需要缓存的 tab 页后，再次从左侧菜单打开，还是显示被缓存的页面内容#I4UY3G](https://gitee.com/lyt-top/vue-next-admin/issues/I4UY3G)
- 🌟 更新 package.json 版本包更新
- 🎯 优化 drawer 和 dialog 组件插槽 title 替换为 header
- 🎯 优化 系统刷新页面缓存丢失的问题
...
- 🎉 新增 Mixin 混入 数据管理 前往体验：[动态组件](https://vue3-vite2-admin.vercel.app/#/learning/mixin)
